 ...
 * <p>The class has a constructor that takes a String representing the invalid column name that caused the exception and a message describing the exception.</p>
 * <p>Example usage:</p>
 * <p>try {
