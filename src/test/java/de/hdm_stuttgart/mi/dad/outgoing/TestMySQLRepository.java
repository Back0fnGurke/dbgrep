...
class TestMySQLRepository {
    ...
    public static void setUp() throws SQLException, IOException {
        ...
        repository = RepositoryFactory.createRepository(connection, "mysql");
    }
    ...
    void test_findTableRowsWithProperties_view() throws FileNotFoundException, SQLException {
        scriptRunner.runScript(new FileReader("src/test/resources/TestMySQLRepository/test_findTableRowsWithProperties_view_test_data.sql"));
