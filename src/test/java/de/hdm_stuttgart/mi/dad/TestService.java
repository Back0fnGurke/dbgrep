...
class TestService {
    ...
    void test_searchThroughColumns_multiple_properties() throws Exception {
        ...
        final Property property2 = PropertyFactory.createProperty(GREATERDATE, LocalDate.now());
        final Property property3 = PropertyFactory.createProperty(GREATERNUMERIC, BigDecimal.valueOf(0));
